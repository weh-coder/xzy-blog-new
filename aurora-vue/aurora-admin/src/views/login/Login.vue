<template>
  <div class="login-container">
    <div class="login-card">
      <div class="login-title">学之余-管理员登录</div>
...
.login-container {
  ...
  right: 0;
  left: 0;
  background: url('https://blog-aurora-weh.oss-cn-shenzhen.aliyuncs.com/aurora/photos/8fd6f3e402f3a365f6dc1144b342a2c5.jpeg') center center / cover
    no-repeat;
