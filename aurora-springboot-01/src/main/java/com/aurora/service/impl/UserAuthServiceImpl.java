...
import static com.aurora.constant.CommonConstant.EMAIL_CONTENT1;
import static com.aurora.constant.CommonConstant.EMAIL_CONTENT2;
...
public class UserAuthServiceImpl implements UserAuthService {
    ...
    public void sendCode(String username) {
        ...
        map.put("content","尊敬的<span style='color:red;'>"+username+"</span>"+EMAIL_CONTENT1 +"<span style='color:blue;'>"+code+"</span>"+EMAIL_CONTENT2);
